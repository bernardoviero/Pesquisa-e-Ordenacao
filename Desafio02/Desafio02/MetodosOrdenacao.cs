...
namespace Desafio02
{
    ...
    {
        public void bolha(List<int> lista)
        {
            int i, tmp;
            bool houveTroca;
        ...
        public void selecao(List<int> lista)
        {
            int i, j, tmp;
            int posMenor;
        ...
        public void insercao(List<int> lista)
        {
            int i, j;
            int tmp;
        ...
        public void agitacao(List<int> lista)
        {
            bool houveTroca;
            int tmp;
        ...
        public void pente(List<int> lista)
        {
        ...
        public void shell(List<int> lista)
        {
            int i, j, distancia = 1;
            int tmp;
        ...
        public void quick(List<int> lista, int ini, int fim)
        {
            int pivo;
        ...
        public void heap(List<int> lista)
        {
            int tmp;
            int i;
            int n = lista.Count;
